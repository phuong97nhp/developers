...
function View() {
    ...
    return <div>
        <h1>Xã phường</h1>
        <hr/>
        <p>Xem tất cả danh mục xã phường</p>
        <div className="customLink get copy">
            https://azexpress.com.vn/wp-json/api/v1/get-address?address=ward
        </div>
        <p>Xã phường theo khu vực quận huyện</p>
        <div className="customLink get copy">
            https://azexpress.com.vn/wp-json/api/v1/get-address?address=ward&label=[ID Quận/Huyện]
        </div>
