...
function Create() {
    ...
    return <div>
        ...
        azexpress.com.vn/wp-json/api/v2/edit-order
        </div> 
        ...
        <div className="customCode copy">
            ...
            <span className="text-warning">code</span>:LRL10000002<br/>
        ...
        <div className="customText">
            <span className="text-success">Chú ý: </span> code  là nhất định phải có
        </div>
       <h4>Id khu vực</h4>
       <div className="customText">
